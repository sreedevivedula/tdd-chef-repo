...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sreedevivedula-starter"
  ...
  #   chef.chef_server_url = "https://chefserver/organizations/mifosx"
  #   chef.validation_client_name = "mifosx-validator"
  #   chef.validation_key_path = ".chef/mifosx-validator.pem"
  # end
end
